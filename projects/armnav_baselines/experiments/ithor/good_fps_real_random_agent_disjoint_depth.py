...
from plugins.ithor_arm_plugin.ithor_arm_task_samplers import RandomAgentWDoneActionTaskSampler, WDoneActionTaskSampler, GoodFPSRandomAgentWDoneActionTaskSampler
...
class GoodFPSRealDisjointDepthRandomAgentLocArmNav(
    ...
    MAX_STEPS = 200
    TASK_SAMPLER = GoodFPSRandomAgentWDoneActionTaskSampler
