...
from plugins.ithor_arm_plugin.ithor_arm_task_samplers import GoodFPSRandomAgentWDoneActionTaskSampler, WDoneActionTaskSampler
...
class GoodFPSRealRGBRandomAgentLocWDoneArmNav(
