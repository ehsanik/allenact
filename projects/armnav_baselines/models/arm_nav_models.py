...
class ArmNavBaselineActorCritic(ActorCriticModel[CategoricalDistr]): #TODO this needs to be changed and the sensors need to be added
...
class ResnetTensorArmNavActorCritic(ActorCriticModel[CategoricalDistr]):
    def __init__(
        self,
        action_space: gym.spaces.Discrete,
        observation_space: SpaceDict,
